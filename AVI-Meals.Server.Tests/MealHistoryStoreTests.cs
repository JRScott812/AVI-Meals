...
public sealed class MealHistoryStoreTests
{
	...
	{
		DailyMenu stored = new(new DateOnly(2026, 1, 5), [new DailyMenuItem("Old", "A", "Lunch", 1m, [])]);
		DailyMenu live = new(new DateOnly(2026, 1, 5), [new DailyMenuItem("New", "B", "Dinner", 2m, [])]);
		DailyMenu older = new(new DateOnly(2026, 1, 1), [new DailyMenuItem("Past", "C", "Breakfast", null, [])]);
